...
<div class="alert alert-primary" role="alert">
  Usted esta a punto de Modificar un Turno. Ingrese la fecha del turno y el Nombre Completo y DNI del paciente que solicitó el turno y luego ingrese los datos nuevos.
</div>



<form action="modificartback.php"   method="POST">


<input type="text" name="nombreMod" class="form-control" placeholder="Nombre Completo">
<br>
<br>
<input type="text" name="dniMod" class="form-control" placeholder="Dni">
<br>
<br>
<label for="">Fecha del turno</label>
<br>
<input type="date" name="fechaMod" class="form-control" >
<br>
