...
<div class="alert alert-danger d-flex align-items-center" role="alert">
  ...
  <div>
    Usted esta a punto de eliminar un Turno, Ingrese la fecha del turno y el Nombre Completo y DNI del paciente que solicitó el turno.
  </div>
</div>



<form action="eliminartback.php"   method="POST">
