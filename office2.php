...
<td><b style=" font-size: x-large;"> Fecha </b></td>
<td><b style=" font-size: x-large;"> Horario</b></td>
...
<button type="button" class="btn btn-primary btn-lg">  <a href="eliminart.php" style="color: white;"> Eliminar Turno </a>    </button>
<button type="button" class="btn btn-primary btn-lg">  <a href="modificart.php " style="color: white;"> Modificar Turno </a>    </button>
<button type="button" class="btn btn-primary btn-lg">  <a href="creart.php " style="color: white;"> Crear Turno </a>    </button>
